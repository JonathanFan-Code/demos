...
enum LOCAL_VIDEO_STREAM_ERROR {
    ...
    /** 21:For IOS AVCaptureSessionInterruptionReasonVideoDeviceNotAvailableInBackground
     */
    LOCAL_VIDEO_STREAM_ERROR_VIDEO_DEVICE_NOT_AVAILABLE_IN_BACKGROUND=21,
    /** 22:For IOS AVCaptureSessionInterruptionReasonAudioDeviceInUseByAnotherClient
     */
    LOCAL_AUDIO_STREAM_ERROR_AUDIO_DEVICE_IN_USE_BY_ANOTHER_CLIENT=22,
    /** 23:For IOS AVCaptureSessionInterruptionReasonVideoDeviceInUseByAnotherClient
     */
    LOCAL_VIDEO_STREAM_ERROR_VIDEO_DEVICE_IN_USE_BY_ANOTHER_CLIENT=23,
    /** 24:For IOS AVCaptureSessionInterruptionReasonVideoDeviceNotAvailableWithMultipleForegroundApps
     */
    LOCAL_VIDEO_STREAM_ERROR_VIDEO_DEVICE_NOT_AVAILABLE_WITH_MULTIPLE_FOREGROUND_APPS=24,
    /** 25:For IOS AVCaptureSessionInterruptionReasonVideoDeviceNotAvailableDueToSystemPressure
     */
    LOCAL_VIDEO_STREAM_ERROR_VIDEO_DEVICE_NOT_AVAILABLE_DUE_TO_SYSTEM_PRESSURE=25,
};
...
struct AudioRecordingConfiguration
{
    ...
    {}
    AudioRecordingConfiguration(const char* path, AUDIO_RECORDING_QUALITY_TYPE quality, AUDIO_RECORDING_POSITION position, int sampleRate)
        : filePath(path)
  ...
  virtual int startEchoTest(int intervalInSeconds) = 0;
    ...
    */
    ...
    /** Starts playing and mixing the music file.
     ...
     - < 0: Failure.
     */
    virtual int startAudioMixing(const char* filePath, bool loopback, bool replace, int cycle, int startPos = 0) = 0;
    ...
    /** Retrieves the duration (ms) of the music file.
     ...
     - < 0: Failure.
     */
    virtual int getAudioMixingDuration(const char *fileName = NULL) = 0;
...
public:
    ...
    int startAudioMixing(const char* filePath, bool loopback, bool replace, int cycle, int startPos = 0) {
        ...
        if (!m_parameter->convertPath(filePath, path))
            ...
            return -ERR_INVALID_ARGUMENT;
#endif
        return setObject("che.audio.start_file_as_playout", "{\"filePath\":\"%s\",\"loopback\":%s,\"replace\":%s,\"cycle\":%d, \"startPos\":%d}",
                         filePath,
                         loopback?"true":"false",
                         replace?"true":"false",
                         cycle, startPos);
