    ...
    namespace EXPRESS
    {
        ...
        public:
            ...
            void setAudioConfig(ZegoAudioConfig audioConfig) override
            {
                ...
                oInternalOriginBridge->setAudioConfig(config);
            }

            ZegoAudioConfig getAudioConfig() override
            {
                zego_audio_config _config = oInternalOriginBridge->getAudioConfig();
            ...
            {
                oInternalOriginBridge->setMinVideoBitrateForTrafficControl(bitrate, zego_traffic_control_min_video_bitrate_mode(mode));
            }
#endif
            ...
            {
                oInternalOriginBridge->muteAudioOutput(mute);
            }
        ...
        public:
            ...
            static void setEngineConfig(ZegoEngineConfig engineConfig)
            {
                ...
                {
                    _engineConfig.custom_video_capture_main_config = nullptr;
                }
                else
                {
                    _custom_video_capture_config_main.buffer_type = zego_video_buffer_type(engineConfig.customVideoCaptureMainConfig->bufferType);
                    _engineConfig.custom_video_capture_main_config = &_custom_video_capture_config_main;
                }
                ...
                {
                    _custom_video_capture_config_aux.buffer_type = zego_video_buffer_type(engineConfig.customVideoCaptureAuxConfig->bufferType);
                ...
                {
                    _custom_video_render_config.buffer_type = zego_video_buffer_type(engineConfig.customVideoRenderConfig->bufferType);
                    _custom_video_render_config.frame_format_series = zego_video_frame_format_series(engineConfig.customVideoRenderConfig->frameFormatSeries);
                    _custom_video_render_config.enable_engine_render = engineConfig.customVideoRenderConfig->enableEngineRender;
