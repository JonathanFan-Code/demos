 ...
 * @param user_context context of user
 */
typedef void(*zego_on_room_stream_update)(const char * room_id, enum zego_update_type update_type, const struct zego_stream* stream_list, unsigned int stream_info_count, void * user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_room_recv_reliable_message_callback(zego_on_room_recv_reliable_message callback_func, void * user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_room_update_reliable_message_info_callback(zego_on_room_update_reliable_message_info callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_room_send_reliable_message_result)(const char * room_id, zego_error error_code, const char * msg_type, zego_seq send_seq, zego_seq latest_seq, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_room_send_reliable_message_result_callback(zego_on_room_send_reliable_message_result callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_room_get_reliable_message_result)(const char * room_id, zego_error error_code, zego_seq send_seq, const struct zego_reliable_message * message, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_room_get_reliable_message_result_callback(zego_on_room_get_reliable_message_result callback_func, void * user_context);
