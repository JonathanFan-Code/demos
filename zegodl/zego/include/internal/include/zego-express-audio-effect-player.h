 ...
 * @param path The absolute path of the local resource. `assets://`、`ipod-library://` and network url are not supported. Set path as NULL if resource is loaded already using [loadResource]
