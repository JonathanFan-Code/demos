 ...
 */
ZEGOEXP_API void EXP_CALL zego_express_upload_log();
 ...
 *
 * When you use the asynchronous destruction engine api, you can obtain whether the SDK has completely released resources by listening to this callback
 *
 * @param user_context context of user
 */
