...
/**
 * Sets the video flip mode of custom video capture (for the specified channel). This interface takes effect only if the custom video buffer type is Texture2D.
 *
