    ...
    namespace EXPRESS {
        ...
        public:
            ...
            int init(unsigned int appID, const char *appSign, bool isTestEnvironment, zego_scenario scenario)
            {
                ...
                printDebugInfoAndPopupWhenError(ZEGO_EXPRESS_MODULE_ENGINE, __FUNCTION__, result);
                return result;
            }
            ...
            {
                int result = zego_express_set_audio_config(audioConfig);
                printDebugInfoAndPopupWhenError(ZEGO_EXPRESS_MODULE_PUBLISHER, __FUNCTION__, result);
            }

            zego_audio_config getAudioConfig()
            {
            ...
            {
                int result = zego_express_enable_traffic_control(enable, property);
                printDebugInfoAndPopupWhenError(ZEGO_EXPRESS_MODULE_PUBLISHER, __FUNCTION__, result);
            }
